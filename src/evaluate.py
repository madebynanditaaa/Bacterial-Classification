# src/evaluate.py
"""
Evaluate a trained ResNet50 model on the test set and save confusion matrix and classification report.

Usage:
    python src/evaluate.py --model_path results/models/resnet50_final.h5
"""
...
def parse_args():
    ...
    parser.add_argument("--model_path", type=str, required=True, help="Path to the trained ResNet50 model (.h5)")
...
def main():
    ...
    norm_cm_path = os.path.join(PLOTS_DIR, "confusion_matrix_normalized.png")
